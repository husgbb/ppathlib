"""This module implements "Local" classes that mimic their associated `ppathlib` non-local
...
tests. See ["Testing code that uses ppathlib"](../../testing_mocked_ppathlib/) for usage
examples.
"""
