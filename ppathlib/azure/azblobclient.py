...
class AzureBlobClient(Client):
    ...
    [`__init__` method][ppathlib.azure.azblobclient.AzureBlobClient.__init__] for detailed
    ...
    def __init__(
        ...
        priority). If no methods are used, a [`MissingCredentialsError`][ppathlib.exceptions.MissingCredentialsError]
        ...
        Args:
            ...
            file_cache_mode (Optional[Union[str, FileCacheMode]]): How often to clear the file cache; see
                [the caching docs](https://ppathlib.drivendata.org/stable/caching/) for more information
                about the options in ppathlib.eums.FileCacheMode.
            local_cache_dir (Optional[Union[str, os.PathLike]]): Path to directory to use as cache
                for downloaded files. If None, will use a temporary directory. Default can be set with
                the `PPATHLIB_LOCAL_CACHE_DIR` environment variable.
