"""This module contains all custom exceptions in the `ppathlib` library. All exceptions
subclass the [`CloudPathException` base exception][ppathlib.exceptions.CloudPathException] to
facilitate catching any exception from this library.
"""


class CloudPathException(Exception):
    """Base exception for all ppathlib custom exceptions."""
