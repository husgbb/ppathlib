...
from ppathlib import patch_open, patch_os_functions, patch_glob, patch_all_builtins
import ppathlib
from ppathlib.cloudpath import CloudPath
...
def test_patch_open_with_env(rig, monkeypatch):
    ...
    try:
        monkeypatch.setenv("PPATHLIB_PATCH_OPEN", "1")
        importlib.reload(ppathlib)
