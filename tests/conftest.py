...
from ppathlib import AzureBlobClient, AzureBlobPath, GSClient, GSPath, S3Client, S3Path
from ppathlib.cloudpath import implementation_registry
from ppathlib.http.httpclient import HttpClient, HttpsClient
from ppathlib.http.httppath import HttpPath, HttpsPath
from ppathlib.local import (
...
import ppathlib.azure.azblobclient
from ppathlib.azure.azblobclient import _hns_rmtree
import ppathlib.s3.s3client
...
def gs_rig(request, monkeypatch, assets_dir, live_server):
    ...
    if live_server:
        ...
        monkeypatch.setattr(ppathlib.gs.gsclient, "google_default_auth", mock_default_auth)
